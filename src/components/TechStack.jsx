...
const TechStack = () => {
  ...
  return (
    <section id="tech-stack" className="term-panel">
      <h2 className="term-header">STACK_INFO</h2>

      <div className="tech-scene-container" style={{ margin: '0 auto', minHeight: '400px' }}>
        <Canvas
